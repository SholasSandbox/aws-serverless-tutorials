...
def test_find_missing_required_field_returns_missing_field(trade, expected_missing_field):  
...
def test_lambda_handler_uses_unknown_request_id_when_request_id_missing_or_invalid(event):
    response = lambda_handler(event, None)
